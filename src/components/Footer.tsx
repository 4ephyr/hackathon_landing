      ...
      <div className="bg-secondary pb-10 px-8">
        <div className="flex sm:justify-between justify-center">
          <div className="p-10 sm:block hidden">
            <h1 className="text-primary font-secondary font-lighter text-xl italic">
              Follow Us On :
            </h1>
            ...
            <div className="flex gap-4 items-center">
              <a href="https://www.instagram.com/iedc.uec/" target="_blank">
                <Image
                  src="/hackathon_landing/assets/iedc.png"
                  width={100}
                  height={100}
                  alt="Iedc"
              ...
              <a href="https://www.instagram.com/race.cse/" target="_blank">
                <Image
                  src="/hackathon_landing/assets/race_dark.png"
                  width={50}
                  height={100}
                  alt="Iedc"
                  className="invert object-contain"
          ...
          <div className="p-10 flex flex-col items-center gap-8">
            <Image
              src="/hackathon_landing/assets/TDLogoDark.svg"
              width={300}
              height={300}
              alt="Logo"
            ></Image>
            <a href="https://uec.ac.in" target="_blank">
              <Image
                src="/hackathon_landing/assets/uec_creamy.png"
                width={70}
                height={70}
                alt="Logo"
              ></Image>
          ...
          <div className="p-10 hidden flex-col items-end content-end text-right sm:flex">
            <h1 className="text-primary font-secondary font-lighter text-xl italic">
              Locate Us :
            </h1>
            <a
              href="https://maps.app.goo.gl/aBkBWGPAz3yUPyNj6"
              target="_blank"
              className="underline text-primary italic text-xl"
            >
              View on Map
            </a>
          </div>
        ...
        <div className="text-center">
          <p className="text-primary font-primary font-semibold pb-4 sm:pb-0">
            © Take Down {year} Hackathon | All Rights Reserved <br /> Powered by
